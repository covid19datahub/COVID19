...
**Policies** for admin areas level 2 and 3 **are inherited** from national-level policies by [Oxford Covid-19 Government Response Tracker](https://github.com/OxCGRT/covid-policy-tracker) using [flags](https://github.com/OxCGRT/covid-policy-tracker/blob/master/documentation/codebook.md). Only "general" policies applied across the whole country (flag=1) are propagated to levels 2 and 3.
