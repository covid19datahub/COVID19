...
vignette: >
  %\VignetteIndexEntry{Lebanon}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

<img src="https://www.countryflags.io/LB/flat/64.png" align="right">
...
x1 <- covid19("LBN", level = 1, verbose = FALSE, vintage = TRUE)
x2 <- covid19("LBN", level = 2, verbose = FALSE, vintage = TRUE)
x3 <- covid19("LBN", level = 3, verbose = FALSE, vintage = TRUE)
