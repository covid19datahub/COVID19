...
vignette: >
  %\VignetteIndexEntry{Nepal}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

<img src="https://www.countryflags.io/NP/flat/64.png" align="right">
...
x1 <- covid19("NPL", level = 1, verbose = FALSE, vintage = TRUE)
x2 <- covid19("NPL", level = 2, verbose = FALSE, vintage = TRUE)
x3 <- covid19("NPL", level = 3, verbose = FALSE, vintage = TRUE)
