...
| `vaccines_1`                                 | Cumulative number of people who received at least one vaccine dose.                                            |
| `vaccines_2`                                 | Cumulative number of people who received all doses prescribed by the vaccination protocol (usually two doses).                                            |
...
| `key_jhu_csse`                                |  The identifier used in the [JHU CSSE Unified COVID-19 Dataset](https://github.com/CSSEGISandData/COVID-19_Unified-Dataset). In particular, this enables to match administrative areas with the [Hydromet dataset](https://github.com/CSSEGISandData/COVID-19_Unified-Dataset/tree/master/Hydromet).                                             |
